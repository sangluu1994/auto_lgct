...
Local $iFileExists = FileExists(@ScriptDir&'\logboss20h.txt')

If $iFileExists Then
	FileDelete(@ScriptDir&'\logboss20h.txt')
EndIf
_FileCreate (@ScriptDir&'\logboss20h.txt')
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
While ($i1 < $accCloneChinhListLength)
	...
	If $dangnhap == False Then
		...
		ContinueLoop
	EndIf
	Local $boss20h = boss20h($x_main, $y_main)
	If $boss20h == False Then
		resetGame()
		ContinueLoop
	EndIf
	FileWrite(@ScriptDir&'\logboss20h.txt',"|*"&$i1)
	$i1 = $i1 + 1
	thoatgame()
WEnd
...
While ($i2 < $accCloneChanhNguListLength)
	...
	If $boss20h == False Then
		...
		ContinueLoop
	EndIf
	FileWrite(@ScriptDir&'\logboss20h.txt',"|**"&$i2)
	$i2 = $i2 + 1
	thoatgame()
WEnd